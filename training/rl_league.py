#!/usr/bin/env python3
# DEADWEIGHT/training/rl_league.py -- ported verbatim from BRAWLPIT/scripts/rl_league.py (itself ported verbatim
# from REDGARDEN/scripts/rl_league.py). Zero game coupling; only this header comment was added. S503-08.
"""
